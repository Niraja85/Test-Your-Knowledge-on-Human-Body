...
q1 = """1. Because its cells has mitochondria,
which of your muscles never tires?
a. Tongue
b. Triceps
c. Heart
d. Gluteus Maximus
...
def play_game():
    """
    The play_game function displays the questions
    and user has to choose the correct answer.
    """
    print(Fore.GREEN + Style.BRIGHT +
          "There are 10 questions with 4 choices (a,b,c,d)\n")
    print(Fore.GREEN + Style.BRIGHT +
          "Please select one choice and enter your answer.\n")
    print(Fore.GREEN + Style.BRIGHT +
        ...
        while True:
            ...
            if answer in valid_answers:
                if answer == questions[question]:
                    ...
                    print(Fore.GREEN +
                          f"Option {questions[question]} is correct choice")
                    print(Style.RESET_ALL)
                    break
            else:
